...
In~\cite{potapov2022computational} a computational model is developed for identifying niche factors that are used in the rejuvination of quiescent stem cells.
Initally, the study focused on skeletal stem cells, the stem like cells do not degrade till much later life.
This model is used can be used for the identification of niche factors of multiple different tissue types.

\section{Introduction}
\fontsize{12}{14}\selectfont
Let me be frank, we don't see the full picture and we should look at the effect of fungi on our systems and 
Whether they can be modified to help us. 
a clear example would be enabling stem cells to grow within modified mycelial compounds.
